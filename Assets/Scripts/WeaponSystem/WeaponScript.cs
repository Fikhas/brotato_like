    ...
    public class WeaponScript : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (GameManager.Instance.gameState == GameState.Gameplay)
            {
                ...
                if (isCanShoot)
                {
                    ...
                    bulletActive.transform.rotation = Quaternion.Euler(new Vector3(0, 0, DirectObsScript.Instance.currentRot));
        ...
        public void AutoShoot(Vector3 targetObj)
        {
            if (isCanAutoShoot)
            {
                ...
                bulletActive.transform.rotation = Quaternion.Euler(new Vector3(0, 0, currentRot));
                bulletActive.transform.position = bulletPos.position;
